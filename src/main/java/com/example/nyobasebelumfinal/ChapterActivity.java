...
public class ChapterActivity extends AppCompatActivity {
   ...
   // MyAdapter.RecyclerViewClikListener listener;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHelper = new DBHelper(ChapterActivity.this);
        catIndex = getIntent().getIntExtra("menus",1);
        ShowRecyclerView();
    ...
    private void ShowRecyclerView() {
        ...
        myAdapter = new MyAdapter(ChapterActivity.this, comic_id, comic_name, comic_category, comic_image);
    ...
    private void storeDataInArrays() {
        Cursor cursor = dbHelper.readAllData(catIndex);
